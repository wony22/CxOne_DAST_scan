...
public class XPathQuery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Encoder esapiEncoder = new Encoder();
            String sanitizedUserId = esapiEncoder.encodeForXPath(user); 
            String sanitizedPassword = esapiEncoder.encodeForXPath(pass); 
            /*  
            ...
            */    
            ...
            // *** Checkmarx 
            //XPath Query:
            // old > String xPression="/users/user[username='"+user+"' and password='"+pass+"']/name";
            String xPression="/users/user[username='"+sanitizedUserId+"' and password='"+sanitizedPassword+"']/name";
            // *** Checkmarx
